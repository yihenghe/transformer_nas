...
class DecoderLayer(nn.Module):
    def __init__(self, hidden_size, filter_size, dropout_rate, head_size):
        ...
        self.enc_dec_attention = MultiHeadAttention(hidden_size, dropout_rate, head_size=head_size)
...
class Encoder(nn.Module):
    def __init__(self, hidden_size, filter_size, dropout_rate, n_layers, head_size):
        ...
        encoders = [EncoderLayer(hidden_size, filter_size, dropout_rate, head_size)
...
class Decoder(nn.Module):
    def __init__(self, hidden_size, filter_size, dropout_rate, n_layers, head_size):
        ...
        decoders = [DecoderLayer(hidden_size, filter_size, dropout_rate, head_size)
                    for _ in range(n_layers)]
...
class Transformer(nn.Module):
    def __init__(self, i_vocab_size, t_vocab_size,
        ...
        self.decoder = Decoder(hidden_size, filter_size,
                               dropout_rate, n_layers, head_size)
