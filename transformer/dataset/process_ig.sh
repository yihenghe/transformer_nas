...
URLS=(
    "https://object.pouta.csc.fi/OPUS-CCMatrix/v1/moses/en-ig.txt.zip"
    "https://object.pouta.csc.fi/OPUS-GNOME/v1/moses/en-ig.txt.zip"
    "https://object.pouta.csc.fi/OPUS-Ubuntu/v14.10/moses/en-ig.txt.zip"
)
FILES=(
    "en-ig.txt.zip"
    "en-ig.txt.zip"
